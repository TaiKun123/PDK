...
[CARD: ID3] (若只需兩支產品，此 [CARD] 標籤與理由請直接省略)
✨ 生活防護：(推薦第三支免沖洗的理由。若本次只需兩支產品則省略此項)
...
> RECOMMEND 推薦防護鎖 (陣列去重與槽位鎖定)：
  ...
  2. 槽位定義：
     ...
     - ID3 為選配，必須是「免沖洗 (hc_開頭)」，針對生活防護【或頭皮理療加強】。若評估客人只需要兩支產品，ID3 請填寫 NONE。
...
- 免沖洗與頭皮保養 (生活習慣防護)：
  1. 全方位頭皮調理液 (hc_005)：含「蜂膠、藍莓與玫瑰萃取」。
     ★觸發條件：針對「頭皮紅癢、發炎、敏感、頭皮屑」的鎮定SPA。(★防呆：若頭皮健康，僅有熬夜或壓力大，請勿推薦此款)。特別適合因熬夜、壓力或戴安全帽「而引發上述症狀」的客人，蜂膠能放鬆舒緩頭皮。
  2. 彈力亮澤護色修護液 (hc_004)：含「18-MEA護色因子」。
     ★觸發條件：針對「需要吹風機抗熱防護與鎖色」者。適合常曬太陽、每天吹整、染燙漂後急救。
  3. 芳香質感精華乳 (hc_003)：含「氨基酸蛋白」。
     ★觸發條件：針對「不喜歡油膩感」的客人。吹風造型前當潤絲打底，完美平衡髮絲健康環境。
  4. 黃金堅果E油 (hc_002)：含「堅果油與橄欖油」。
     ★觸發條件：針對「頻繁使用離子夾/電棒」的強效熱防護，或「極度乾枯分岔」者。雙重保濕鎖色，一抹找回亮澤。
  5. 摩洛哥Q10精華修復液 (hc_001)：含「摩洛哥堅果油、維他命E與Q10」。
     ★觸發條件：針對「易斷裂、脆弱細軟髮」。能抵禦外在傷害，瞬間柔滑防斷裂。
